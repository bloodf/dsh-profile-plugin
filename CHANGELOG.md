...
- Matched profile controls to native Harness dark/light design tokens and density.
- Added authoritative client session profile filtering and selected-profile session creation.
- Inlined CSS into the single client bundle expected by the Harness module loader.
